...
class Parser:
  ...
  def statement(self):
    ...
    if self.current_tok.matches(TT_KEYWORD, 'wetuwn'):
      res.register_advancement()
      self.advance()
    ...
    if self.current_tok.matches(TT_KEYWORD, 'wesume'):
      res.register_advancement()
      self.advance()
  ...
  def expr(self):
    ...
    if self.current_tok.matches(TT_KEYWORD, 'vawiabwe'):
      res.register_advancement()
      self.advance()
    ...
    node = res.register(self.bin_op(self.comp_expr, ((TT_KEYWORD, 'nyand'), (TT_KEYWORD, 'ow'))))
  ...
  def comp_expr(self):
    ...
    if self.current_tok.matches(TT_KEYWORD, 'nyot'):
  ...
  def atom(self):
    ...
    elif tok.matches(TT_KEYWORD, 'nyif'):
      if_expr = res.register(self.if_expr())
      if res.error: return res
      return res.success(if_expr)

    elif tok.matches(TT_KEYWORD, 'fur'):
      for_expr = res.register(self.for_expr())
      if res.error: return res
      return res.success(for_expr)

    elif tok.matches(TT_KEYWORD, 'whiwe'):
      while_expr = res.register(self.while_expr())
      if res.error: return res
      return res.success(while_expr)

    elif tok.matches(TT_KEYWORD, 'fwunc'):
  ...
  def if_expr(self):
    res = ParseResult()
    all_cases = res.register(self.if_expr_cases('nyif'))
    if res.error: return res
    cases, else_case = all_cases
    return res.success(IfNode(cases, else_case))

  def if_expr_b(self):
    return self.if_expr_cases('nyelsenyif')
    
  def if_expr_c(self):
    res = ParseResult()
    else_case = None

    if self.current_tok.matches(TT_KEYWORD, 'nyelse'):
      res.register_advancement()
      self.advance()
      ...
      if self.current_tok.type == TT_NEWLINE:
        ...
        if self.current_tok.matches(TT_KEYWORD, 'cwose'):
          res.register_advancement()
          self.advance()
        else:
          return res.failure(InvalidSyntaxError(
  ...
  def if_expr_b_or_c(self):
    ...
    if self.current_tok.matches(TT_KEYWORD, 'nyelsenyif'):
...
class Interpreter:
  ...
  def visit_BinOpNode(self, node, context):
    ...
    elif node.op_tok.matches(TT_KEYWORD, 'nyand'):
      result, error = left.anded_by(right)
    elif node.op_tok.matches(TT_KEYWORD, 'ow'):
  ...
  def visit_UnaryOpNode(self, node, context):
    ...
    elif node.op_tok.matches(TT_KEYWORD, 'nyot'):
...
global_symbol_table.set("nuww", Number.null)
...
global_symbol_table.set("pwint_wet", BuiltInFunction.print_ret)
global_symbol_table.set("input", BuiltInFunction.input)
global_symbol_table.set("input_integew", BuiltInFunction.input_int)
global_symbol_table.set("input_fwoat", BuiltInFunction.input_float)
...
global_symbol_table.set("wun", BuiltInFunction.run)
